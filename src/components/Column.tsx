...
//   return (
//     <>
//       <div className="bg-white rounded-2xl shadow-md p-4 min-h-[400px] border border-gray-100">
...
//               <div
//                 key={task.id}
//                 className="border rounded-xl p-3 shadow-sm hover:shadow-md transition duration-200"
//               >
...
//                         )
//                       }
//                       className="bg-blue-500 hover:bg-blue-600 transition text-white px-3 py-1 rounded-lg"
//                     >
//                       Move →
//                     </button>
//                   )}
